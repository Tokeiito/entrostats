...
Func read_log_line()
	...
	$cdmgout = StringRegExp($chat_log_line, "] Critical hit - Additional damage! You inflicted", 0)
	$miss = StringRegExp($chat_log_line, "] The target Dodged your attack", 0)
	$dmgin = StringRegExp($chat_log_line, "] You took", 0)
